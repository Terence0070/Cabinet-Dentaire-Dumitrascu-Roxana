...
$title = "Contact";
$metaDescription = "Le formulaire de contact du site web Cabinet Dentaire Dumitrascu Roxana";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($response->success) {
    ...
    if (!$hasErrors) {
        ...
        $full_message = "";
        myMail('cab.dumitrascu@gmail.com', $sujet, $full_message);
            ...
            <form action="" method="POST" onsubmit="onClick(event)">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                      En envoyant ce formulaire, vous acceptez qu'on recueille les données envoyées afin de vous identifier et vous répondre. Votre nom, votre prénom ainsi que votre adresse email (si renseignée) seront stockés sur notre base de données conformémant à notre <a href="politique">politique de confidentialité</a>.
                  </label>
                </div>
